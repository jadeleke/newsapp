...
public class DetailActivityTest {
    ...
    public void webViewTest() throws ExceptionInInitializerError {
        ...
        onWebView( withId( R.id.wv ) ).forceJavascriptEnabled();
    ...
    @Test
    public void testProgressTask() throws Throwable {

        int[] progressCount = {0};
        final AsyncTask<Void, Integer, Void> testTask = new AsyncTask<Void, Integer, Void>() {

            @Override
            protected Void doInBackground(Void... voids) {
                while (progressCount[0] < 100) {
                    progressCount[0]++;
                    publishProgress( progressCount[0] );
